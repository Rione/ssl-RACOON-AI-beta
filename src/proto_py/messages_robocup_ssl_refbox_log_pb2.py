...
Log_Frame = _reflection.GeneratedProtocolMessageType('Log_Frame', (_message.Message,), {
...
Refbox_Log = _reflection.GeneratedProtocolMessageType('Refbox_Log', (_message.Message,), {
