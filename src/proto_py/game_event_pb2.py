...
_SSL_REFEREE_GAME_EVENT_GAMEEVENTTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="MULTIPLE_DEFENDER_PARTIALLY",
            index=9,
            number=9,
            serialized_options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="DEFENDER_TO_KICK_POINT_DISTANCE",
            index=18,
            number=18,
            serialized_options=None,
            type=None,
...
_SSL_REFEREE_GAME_EVENT_ORIGINATOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="team",
            full_name="SSL_Referee_Game_Event.Originator.team",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="botId",
            full_name="SSL_Referee_Game_Event.Originator.botId",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
...
_SSL_REFEREE_GAME_EVENT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="SSL_Referee_Game_Event.message",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _SSL_REFEREE_GAME_EVENT_ORIGINATOR,
    ],
    enum_types=[
...
SSL_Referee_Game_Event = _reflection.GeneratedProtocolMessageType(
    "SSL_Referee_Game_Event",
    (_message.Message,),
    {
        "Originator": _reflection.GeneratedProtocolMessageType(
            "Originator",
            (_message.Message,),
            {
