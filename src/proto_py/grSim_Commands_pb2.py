...
_GRSIM_ROBOT_COMMAND = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="grSim_Robot_Command.id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="kickspeedx",
            full_name="grSim_Robot_Command.kickspeedx",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="kickspeedz",
            full_name="grSim_Robot_Command.kickspeedz",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="veltangent",
            full_name="grSim_Robot_Command.veltangent",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="velnormal",
            full_name="grSim_Robot_Command.velnormal",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="velangular",
            full_name="grSim_Robot_Command.velangular",
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="spinner",
            full_name="grSim_Robot_Command.spinner",
            index=6,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="wheelsspeed",
            full_name="grSim_Robot_Command.wheelsspeed",
            index=7,
            number=8,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="wheel1",
            full_name="grSim_Robot_Command.wheel1",
            index=8,
            number=9,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="wheel2",
            full_name="grSim_Robot_Command.wheel2",
            index=9,
            number=10,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="wheel3",
            full_name="grSim_Robot_Command.wheel3",
            index=10,
            number=11,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="wheel4",
            full_name="grSim_Robot_Command.wheel4",
            index=11,
            number=12,
            type=2,
            cpp_type=6,
...
_GRSIM_COMMANDS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="grSim_Commands.timestamp",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="isteamyellow",
            full_name="grSim_Commands.isteamyellow",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="robot_commands",
            full_name="grSim_Commands.robot_commands",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
grSim_Robot_Command = _reflection.GeneratedProtocolMessageType(
    "grSim_Robot_Command",
    (_message.Message,),
    {
...
grSim_Commands = _reflection.GeneratedProtocolMessageType(
    "grSim_Commands",
    (_message.Message,),
    {
