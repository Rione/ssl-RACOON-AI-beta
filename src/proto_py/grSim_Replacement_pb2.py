...
_GRSIM_ROBOTREPLACEMENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="grSim_RobotReplacement.x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="grSim_RobotReplacement.y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="dir",
            full_name="grSim_RobotReplacement.dir",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="id",
            full_name="grSim_RobotReplacement.id",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="yellowteam",
            full_name="grSim_RobotReplacement.yellowteam",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="turnon",
            full_name="grSim_RobotReplacement.turnon",
            index=5,
            number=6,
            type=8,
            cpp_type=7,
...
_GRSIM_BALLREPLACEMENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="grSim_BallReplacement.x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="grSim_BallReplacement.y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="vx",
            full_name="grSim_BallReplacement.vx",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="vy",
            full_name="grSim_BallReplacement.vy",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
...
_GRSIM_REPLACEMENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="ball",
            full_name="grSim_Replacement.ball",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="robots",
            full_name="grSim_Replacement.robots",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
grSim_RobotReplacement = _reflection.GeneratedProtocolMessageType(
...
grSim_BallReplacement = _reflection.GeneratedProtocolMessageType(
...
grSim_Replacement = _reflection.GeneratedProtocolMessageType(
    "grSim_Replacement",
    (_message.Message,),
    {
