...
def on_indirect_their_cbf(logger: Logger, args: tuple[Defense, Keeper, Offense]) -> list[RobotCommand]:
    """on_indirect_their_cbf

    This function is to prepare enemy indirect free kick.
