...
class Game:
    ...
    def _set_texts(self) -> None:
        ...
        self.__command_text.setFont(QtGui.QFont("Arial", 18))
        ...
        self.__replacement_x.setFont(QtGui.QFont("Arial", 16))
        ...
        self.__score_yellow.setFont(QtGui.QFont("Arial", 18))
