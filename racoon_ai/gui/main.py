...
class Gui(QWidget, QPainter):
    ...
    def _draw_role(self) -> None:
        self.__role.move(int(600 * self.__window_width), int(740 * self.__window_height))
        self.__at.move(int(600 * self.__window_width), int(780 * self.__window_height))
        ...
        for robot in robots:
            if robot.x != 0:
                ...
                self.__ui.drawChord(
                    ...
                    int(((robot.x * 0.05) + 370) * self.__window_width - 7),
                    14,
                    14,
