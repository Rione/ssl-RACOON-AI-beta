...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        grSim__Commands__pb2.DESCRIPTOR,
        grSim__Replacement__pb2.DESCRIPTOR,
    ],
)
...
_GRSIM_PACKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="commands",
            full_name="grSim_Packet.commands",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="replacement",
            full_name="grSim_Packet.replacement",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
grSim_Packet = _reflection.GeneratedProtocolMessageType(
    "grSim_Packet",
    (_message.Message,),
    {
