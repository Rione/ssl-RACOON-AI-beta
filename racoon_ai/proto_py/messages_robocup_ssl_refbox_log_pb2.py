...
_LOG_FRAME = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="refbox_cmd",
            full_name="Log_Frame.refbox_cmd",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
Log_Frame = _reflection.GeneratedProtocolMessageType(
    "Log_Frame",
    (_message.Message,),
    {
...
Refbox_Log = _reflection.GeneratedProtocolMessageType(
    "Refbox_Log",
    (_message.Message,),
    {
