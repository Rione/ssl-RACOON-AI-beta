...
import proto_py.messages_robocup_ssl_geometry_pb2 as messages__robocup__ssl__geometry__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        messages__robocup__ssl__detection__pb2.DESCRIPTOR,
        messages__robocup__ssl__geometry__pb2.DESCRIPTOR,
    ],
)
...
_SSL_WRAPPERPACKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="detection",
            full_name="SSL_WrapperPacket.detection",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="geometry",
            full_name="SSL_WrapperPacket.geometry",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
